...
public class Config
{
    ...
    public static string FOLDER =
            ...
            ?? @"C:\6.Semester\ArkitekturPrincipper\seData\seData copy\large\arnold-j";
    ...
    public static string RABBITMQ_USER =
        Environment.GetEnvironmentVariable("RABBITMQ_USER") ?? "searchuser";

    public static string RABBITMQ_PASSWORD =
        Environment.GetEnvironmentVariable("RABBITMQ_PASSWORD") ?? "searchpass123";
